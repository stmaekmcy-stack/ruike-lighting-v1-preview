...
try {
  ...
  for (const path of ['/about/', '/choosing-ruike/', '/brand-features/', '/lighting-delivery/', '/service-difference/', '/project-process/', '/suitable-projects/', '/cases/', '/cases/mooleeq-studio/', '/privacy.html', '/terms.html', '/favicon.svg', '/robots.txt', '/sitemap.xml', '/llms.txt', '/assets/hero-architecture.webp', '/assets/ruike-wechat-official.jpg']) {
